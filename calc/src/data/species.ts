...
const XY_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Arbok: {types: ['Poision', 'Dark'], bs: {hp: 80, at: 105}},
  ...
  Beautifly: {bs: {sa: 100}},
  Beedrill: {bs: {at: 95, sp: 95}, otherFormes: ['Beedrill-Mega']},
  Bellossom: {bs: {df: 95}},
  ...
  Dewgong: {bs: {sa: 95, sd: 90}},
  Dodrio: {bs: {hp: 80}},
  Exploud: {bs: {sd: 73}},
  'Farfetch\u2019d': {types: ['Fighting', 'Flying'], bs: {sp: 100}},
  Fearow: {bs: {at: 110}},
  ...
  Golduck: {types: ['Water', 'Psychic'], bs: {at: 102, sa: 105}},
  ...
  Jigglypuff: {types: ['Normal', 'Fairy'], bs: {hp: 105, sa: 65, sd: 35}},
  Jumpluff: {bs: {sd: 95}},
  ...
  Pidgeot: {bs: {at: 70, sa: 105, sp: 101}, otherFormes: ['Pidgeot-Mega']},
  Pikachu: {
    bs: {df: 40, sd: 50},
    otherFormes: [
      'Pikachu-Belle',
  ...
  Victreebel: {bs: {sd: 70}},
  Vileplume: {bs: {hp: 95, at: 60, df: 95, sa: 120, sd: 100}},
  Whimsicott: {types: ['Grass', 'Fairy']},
  Wigglytuff: {types: ['Normal', 'Fairy'], bs: {hp: 120, sa: 105, sd: 95}},
  'Aegislash-Blade': {
    types: ['Steel', 'Ghost'],
